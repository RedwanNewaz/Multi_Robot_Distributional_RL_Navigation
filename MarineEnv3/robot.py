    ...
    def perception_output(self, obstacles, robots, in_robot_frame=True):
        ...
        if in_robot_frame:
            ...
            self.perception.observation["self"] = [self.x, self.y, self.theta, self.speed, self.velocity[0],
                                                   self.velocity[1], self.goal[0], self.goal[1]]
        ...
        if self.cooperative:
            ...
            for j, robot in enumerate(robots):
                ...
                if in_robot_frame:
                    ...
                    self.perception.observation["dynamic"].append(
        ...
        static_observations = copy.deepcopy(heapq.nsmallest(self.perception.max_obs_num,
                                                            ...
                                                            key=lambda obs: self.compute_distance(obs[0], obs[1],
                                                                                                  obs[2], True)))
        ...
        if self.cooperative:
            ...
            dynamic_observations = copy.deepcopy(heapq.nsmallest(self.perception.max_obj_num,
                                                                 ...
                                                                 key=lambda obj: self.compute_distance(obj[0], obj[1],
                                                                                                       self.r, True)))
        else:
